!function(y){"function"==typeof define&&define.amd?define(y):y()}(function(){function y(h,b){for(var f=0;f<b.length;f++){var c=b[f];c.enumerable=c.enumerable||!1;c.configurable=!0;"value"in c&&(c.writable=!0);Object.defineProperty(h,c.key,c)}}function E(){return(E=Object.assign||function(h){for(var b=1;b<arguments.length;b++){var f=arguments[b],c;for(c in f)Object.prototype.hasOwnProperty.call(f,c)&&(h[c]=f[c])}return h}).apply(this,arguments)}function F(h){return(F=Object.setPrototypeOf?Object.getPrototypeOf:
function(b){return b.__proto__||Object.getPrototypeOf(b)})(h)}function A(h,b){return(A=Object.setPrototypeOf||function(f,c){return f.__proto__=c,f})(h,b)}function M(){if("undefined"==typeof Reflect||!Reflect.construct||Reflect.construct.sham)return!1;if("function"==typeof Proxy)return!0;try{return Date.prototype.toString.call(Reflect.construct(Date,[],function(){})),!0}catch(h){return!1}}function G(h,b,f){return(G=M()?Reflect.construct:function(c,g,a){var d=[null];d.push.apply(d,g);c=new (Function.bind.apply(c,
d));return a&&A(c,a.prototype),c}).apply(null,arguments)}function H(h){var b="function"==typeof Map?new Map:void 0;return(H=function(f){function c(){return G(f,arguments,F(this).constructor)}if(null===f||(g=f,-1===Function.toString.call(g).indexOf("[native code]")))return f;var g;if("function"!=typeof f)throw new TypeError("Super expression must either be null or a function");if(void 0!==b){if(b.has(f))return b.get(f);b.set(f,c)}return c.prototype=Object.create(f.prototype,{constructor:{value:c,enumerable:!1,
writable:!0,configurable:!0}}),A(c,f)})(h)}function I(h){if(void 0===h)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return h}var x={},L=function(h){var b=void 0===h?{}:h,f=b.data,c=b.weeks;h=b.legend;var g=b.labels,a=b.preloader,d=b.step,k=b.branding,e=b.svgWidth,l="Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "),v=g?25:0,q=g?18:0;b=[];for(var t=0;t<c;t+=1)b.push(t);var J=[];for(t=0;7>t;t+=1)J.push(t);var z,w=(e-v-4*(c-1))/c;e+=5;t=q+7*w+24+7;var B=
(z=7*c,z-=7-(new Date).getDay());z=function(){for(var m,n=[],r=(new Date).getTime()-864E5*B,p=0;p<c;p+=1){var u=(new Date(r+6048E5*p)).getMonth();m!==u&&(n.push({weekIndex:p,month:u}),m=u)}return n}();var K=function(m,n){var r=B-(7*m+n+1);r=new Date((new Date).getTime()-864E5*r);var p=function(u){return 10>u?"0"+u:u};return r.getFullYear()+"-"+p(r.getMonth()+1)+"-"+p(r.getDate())},O=function(m,n){var r=["codersrank-activity-day"],p=function(u){var C=0;if(!f||!u)return C;var D=f[u];return D&&Object.keys(D).forEach(function(N){C+=
D[N]}),C}(K(m,n));p=0<p?Math.min(Math.floor(p/d),3)+1:0;return p&&r.push("codersrank-activity-day-"+p),7*m+n+1>B&&r.push("codersrank-activity-day-disabled"),r.join(" ")};return'\n    <div class="codersrank-activity">\n      <div class="codersrank-activity-chart">\n        <svg viewBox="0 0 '+e+" "+t+'" height="'+t+'">\n          <g transform="translate('+v+", "+q+')">\n            '+b.map(function(m){return'\n            <g transform="translate('+(w+4)*m+', 0)">\n              '+J.map(function(n){return'\n              <rect\n                width="'+
w+'"\n                height="'+w+'"\n                rx="1.5"\n                x="0"\n                y="'+(w+4)*n+'"\n                data-date="'+K(m,n)+'"\n                class="'+O(m,n)+'"\n              />\n              '}).join("")+"\n            </g>\n            "}).join("")+"\n          </g>\n\n          "+(g?"\n          <g>\n            "+"Mon Tue Wed Thu Fri Sat Sun".split(" ").map(function(m,n){return'\n            <text\n              class="codersrank-activity-wday"\n              text-anchor="start"\n              dominant-baseline="hanging"\n              dx="0"\n              dy="'+
...
d.stackoverflow+" activities</li>\n          ":"")+"\n        </ul>\n      "},g.showTooltip=function(a){if(this.data&&a&&this.tooltip&&this.widgetEl&&this.data[a]){var d=this.shadowEl.querySelector('[data-date="'+a+'"]');if(d){this.tempDiv.innerHTML='\n      <div class="codersrank-activity-tooltip">\n        '+this.tooltipText(a)+'\n        <div class="codersrank-activity-tooltip-angle"></div>\n      </div>\n    ';a=this.getBoundingClientRect();d=d.getBoundingClientRect();var k=this.tempDiv.querySelector(".codersrank-activity-tooltip"),
e=d.left-a.left,l=-5;110>e&&(l=-5-(110-e),e=110);e+110>a.width&&(l=105-(a.width-e),e=a.width-110);l=Math.max(Math.min(l,105),-105);k.style.left=e+"px";k.style.top=d.top-a.top+"px";k.querySelector(".codersrank-activity-tooltip-angle").style.marginLeft=l+"px";this.shadowEl.appendChild(k)}}},g.hideTooltip=function(){if(this.tooltip&&this.widgetEl){var a=this.shadowEl.querySelector(".codersrank-activity-tooltip");a&&this.shadowEl.removeChild(a)}},g.onMouseEnter=function(a){"rect"===a.target.tagName&&
(a=a.target.getAttribute("data-date"),this.showTooltip(a))},g.onMouseLeave=function(){this.hideTooltip()},g.attributeChangedCallback=function(){this.mounted&&this.loadAndRender()},g.attachEvents=function(){this.widgetEl&&(this.widgetEl.addEventListener("mouseenter",this.onMouseEnter,!0),this.widgetEl.addEventListener("mouseleave",this.onMouseLeave,!0))},g.detachEvents=function(){this.widgetEl&&(this.widgetEl.removeEventListener("mouseenter",this.onMouseEnter,!0),this.widgetEl.removeEventListener("mouseleave",
this.onMouseLeave,!0))},g.connectedCallback=function(){this.width=this.offsetWidth;this.mounted=!0;this.loadAndRender()},g.disconnectedCallback=function(){this.mounted=!1;this.detachEvents()},c=[{key:"observedAttributes",get:function(){return"username weeks svg-width legend labels id".split(" ")}}],f=[{key:"tooltip",get:function(){var a=this.getAttribute("tooltip");return""===a||"true"===a},set:function(a){this.setAttribute("tooltip",a)}},{key:"id",get:function(){return this.getAttribute("id")},set:function(a){this.setAttribute("id",
a)}},{key:"username",get:function(){return this.getAttribute("username")},set:function(a){this.setAttribute("username",a)}},{key:"weeks",get:function(){return Math.min(parseInt(this.getAttribute("weeks")||52,10),52)},set:function(a){this.setAttribute("weeks",a)}},{key:"svgWidth",get:function(){var a=parseInt(this.getAttribute("svg-width")||0,10);return!a&&52>this.weeks?800/(52/this.weeks):a||800},set:function(a){this.setAttribute("svg-width",a)}},{key:"svg-width",set:function(a){this.setAttribute("svg-width",
a)}},{key:"legend",get:function(){var a=this.getAttribute("legend");return""===a||"true"===a},set:function(a){this.setAttribute("legend",a)}},{key:"labels",get:function(){var a=this.getAttribute("labels");return""===a||"true"===a},set:function(a){this.setAttribute("labels",a)}},{key:"step",get:function(){return parseInt(this.getAttribute("step")||10,10)},set:function(a){this.setAttribute("step",a)}},{key:"branding",get:function(){return"false"!==this.getAttribute("branding")},set:function(a){this.setAttribute("branding",
a)}}],y(b.prototype,f),c&&y(b,c),b}(H(HTMLElement));window.customElements&&!window.customElements.get("codersrank-activity")&&window.customElements.define("codersrank-activity",P)});
